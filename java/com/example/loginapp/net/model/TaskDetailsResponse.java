...
public class TaskDetailsResponse {
    ...
    public DeliveryTask delivery_task;

    public static class DeliveryTask {
        public long pickup_task_id;
        public long delivery_task_id;

        public String pickup_status;   // e.g. "completed"
        public String delivery_status; // e.g. "completed"
    }
